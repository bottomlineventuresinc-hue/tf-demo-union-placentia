/* Template Factory - Union Landscaping live demo journey.
...
(function () {
  ...
  var LIVE_URL = 'https://bottomlineventuresinc-hue.github.io/tf-demo-union-placentia/';
  var LS_CHANGES = 'tf_union_change_log_v1';
  var LS_PURCHASED = 'tf_union_purchased_v1';
  ...
  function setBarMode(mode) {
    ...
    if (!barSub) return;
    if (mode === 'updated') {
      barSub.textContent = 'Draft for Daniel at Union Landscaping. Claim it, preview the rest of the journey, or request a change.';
    } else {
      barSub.textContent = 'Draft for Daniel at Union Landscaping. Claim it, preview the rest of the journey, or request a change.';
    }
  }
  ...
  if (changeForm) {
    changeForm.addEventListener('submit', function (e) {
      ...
      runSpinner(
        ...
        'Updating the draft for Union Landscaping. Hang tight.',
        delay,
        function () {
